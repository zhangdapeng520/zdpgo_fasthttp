...
func ExpvarHandler(ctx *zdpgo_fasthttp.RequestCtx) {
	...
	if err != nil {
		...
		ctx.SetStatusCode(zdpgo_fasthttp.StatusBadRequest)
		return
	}
...
func getExpvarRegexp(ctx *zdpgo_fasthttp.RequestCtx) (*regexp.Regexp, error) {
