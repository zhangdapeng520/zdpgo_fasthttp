...
// ConvertRequest convert azdpgo_fasthttp.Request to an http.Request
// forServer should be set to true when the http.Request is going to passed to a http.Handler.
func ConvertRequest(ctx *zdpgo_fasthttp.RequestCtx, r *http.Request, forServer bool) error {
	body := ctx.PostBody()
