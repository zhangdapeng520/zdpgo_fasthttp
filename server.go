...
// any file on your filesystem! Usezdpgo_fasthttp.FS with a sane Root instead.
...
func (s *Server) Serve(ln net.Listener) error {
	...
	for {
		...
		if !wp.Serve(c) {
			...
			//
			// See also: https://github.com/zhangdapeng520/zdpgo_fasthttp/pull/485#discussion_r239994990
